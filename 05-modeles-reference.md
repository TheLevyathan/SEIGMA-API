...
~15 endpoints retournent systématiquement HTTP 500 (`User/search`, `Invoice/search`, `Activity/search`, `SalesOrderLine/*`, `Contact/search`, etc.). `Employee/search` a été corrigé en juin 2026.

> → Voir [Chapitre 7 — Pièges et limitations](07-pitfalls-limitations.md) pour la liste exhaustive, les symptômes et les workarounds.
