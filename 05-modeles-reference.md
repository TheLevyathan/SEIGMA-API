...
> **Note** : Les comptes d'enregistrements sont basés sur l'instance `blvitres.seigma.app` en juin 2026. Ils varient selon l'instance.
...
| Champ | Format |
|-------|--------|
| `CustomerId` | `{"ReferenceId": "12f8d783-..."}` |
| `PaymentTermId` | `{"ReferenceId": "0084a215-..."}` |
| `WarehouseId` | `{"ReferenceId": "4a7f2109-..."}` |

> ⚠️ Sans ces 3 champs, l'API retourne **400** avec les messages `[Client] doit être défini`, `[Termes] doit être défini`, `[Entrepôt] doit être défini`.
...
| Display | ReferenceId |
|---------|-------------|
| SUR RÉCEPTION | `0084a215-9858-4ac4-b4f7-30a4ea117535` |
| NET 45 | `f9e45bbe-...` |
| NET 365 | `8e2f0415-...` |
| (4ᵉ terme) | `...` |
...
| Display | ReferenceId |
|---------|-------------|
| Principal | `4a7f2109-5f9c-4efb-bd0f-d06b0db3c05c` |
...
| `POST /api/reference/Employee/search` | 🔴 500 | `Null parameter` |
...
| `SalesInvoice` | ~665 | Variable | ✅ | ✅ | ❌ IGNORÉ | ❓ | ❓ | 🟡 Partiel |
| `Receipt` | ~925 | `RE-XXXXX` | ✅ | ✅ | ❌ IGNORÉ | ❓ | ❓ | 🟡 Partiel |
...
| Receipt | `CustomerId`, `SalesInvoiceId` | Customer, SalesInvoice |
